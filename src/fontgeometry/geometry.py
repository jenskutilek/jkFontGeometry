...
def angle_between_points(
    p0: "TuplePoint", p1: "TuplePoint", do_round: bool = False
) -> float | int:
...
def round_point(pt: "TuplePoint") -> "TuplePoint":
    # FIXME: Use proper rounding
    return (int(round(pt[0])), int(round(pt[1])))


def round_point_conditional(pt: "TuplePoint", do_round: bool = True) -> "TuplePoint":
    if do_round:
        return (int(round(pt[0])), int(round(pt[1])))
    else:
        return pt
...
def triangle_angles(
    p0: "TuplePoint", p1: "TuplePoint", p2: "TuplePoint", p3: "TuplePoint"
...
def triangle_area(
    a: "TuplePoint", b: "TuplePoint", c: "TuplePoint", do_round: bool = False
) -> float:
...
def is_on_left(a: "TuplePoint", b: "TuplePoint", c: "TuplePoint") -> bool:
    # Is point c on the left of ab?
    return triangle_area(a, b, c) > 0


def is_on_right(a: "TuplePoint", b: "TuplePoint", c: "TuplePoint") -> bool:
    # Is point c on the right of ab?
    return triangle_area(a, b, c) < 0


def is_collinear(a: "TuplePoint", b: "TuplePoint", c: "TuplePoint") -> bool:
    # Is point c on ab?
    return triangle_area(a, b, c) == 0
...
def dot_product_2d(p1: "TuplePoint", p2: "TuplePoint", p3: "TuplePoint") -> float:
...
def line_coefficients(p1: "TuplePoint", p2: "TuplePoint") -> tuple[float, float, float]:
